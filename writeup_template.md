...
As a first step, I decided to convert the images to grayscale because, it will introduce little bit color invariant. I.e, our image, even it is coming with slighter change in color (due to the camera or whatever), our model will be able to predict 

Here is an example of a traffic sign image before and after grayscaling.

![alt text][image2]

As a last step, I normalized the image data because, normalized images has 0 mean and small variance (generally 1). Data set  which is having the small constant mean tend to perform well because of gradient decent can converge faster in these set. 
